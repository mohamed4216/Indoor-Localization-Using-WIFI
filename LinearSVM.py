...
#Files: AccuracyLinearSVM && ErrorLinearSVM
AccuracyLinearSVM = open("AccuracyLinearSVM.txt","w")
ErrorLinearSVM = open("ErrorLinearSVM.txt", "w")
...
for i in range(93,2094,100):
	...
	acc.append(accuracy)
	AccuracyLinearSVM.write("Size: "+ str(i)+"||Accuracy: "+str(accuracy)+"\n")
	...
	err.append(error)
	ErrorLinearSVM.write("Size: "+str(i)+"||Error: "+str(error)+"\n")
	print "Error: "+ str(error)
	print "########################"

AccuracyLinearSVM.close()
ErrorLinearSVM.close()
