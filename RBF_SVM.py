...
#Files: AccuracyRBFSVM && ErrorRBFSVM
AccuracyRBFSVM = open("AccuracyRBFSVM.txt","w")
ErrorRBFSVM = open("ErrorRBFSVM.txt", "w")
...
for i in range(93,2094,100):
	...
	acc.append(accuracy)
	AccuracyRBFSVM.write("Size: "+ str(i)+"||Accuracy: "+str(accuracy)+"\n")
	...
	err.append(error)
	ErrorRBFSVM.write("Size: "+str(i)+"||Error: "+str(error)+"\n")
	print "Error: "+ str(error)
	print "########################"

AccuracyRBFSVM.close()
ErrorRBFSVM.close()
