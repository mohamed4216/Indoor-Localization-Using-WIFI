...
#Files: AccuracyRForest && ErrorRForest
AccuracyRForest = open("AccuracyRForest.txt","w")
ErrorRForest = open("ErrorRForest.txt", "w")
...
for i in range(93,2094,100):
	...
	acc.append(accuracy)
	AccuracyRForest.write("Size: "+ str(i)+"||Accuracy: "+str(accuracy)+"\n")
	...
	err.append(error)
	ErrorRForest.write("Size: "+str(i)+"||Error: "+str(error)+"\n")
	print "Error: "+ str(error)
	print "########################"

AccuracyRForest.close()
ErrorRForest.close()
